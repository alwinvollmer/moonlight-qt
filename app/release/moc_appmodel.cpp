...
template <> constexpr inline auto AppModel::qt_create_metaobjectdata<qt_meta_tag_ZN8AppModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(NvComputer *, NvApp, QUrl)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 4, 5 }, { 0x80000000 | 7, 8 }, { 0x80000000 | 9, 10 },
        }}),
        // Method 'initialize'
        QtMocHelpers::MethodData<void(ComputerManager *, int, bool)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 12, 13 }, { QMetaType::Int, 14 }, { QMetaType::Bool, 15 },
        }}),
        // Method 'createSessionForApp'
        QtMocHelpers::MethodData<Session *(int)>(16, 2, QMC::AccessPublic, 0x80000000 | 17, {{
            { QMetaType::Int, 18 },
        }}),
        // Method 'getDirectLaunchAppIndex'
        QtMocHelpers::MethodData<int()>(19, 2, QMC::AccessPublic, QMetaType::Int),
        // Method 'getRunningAppId'
        QtMocHelpers::MethodData<int()>(20, 2, QMC::AccessPublic, QMetaType::Int),
        ...
        // Method 'setAppHidden'
        QtMocHelpers::MethodData<void(int, bool)>(23, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 18 }, { QMetaType::Bool, 24 },
        }}),
        // Method 'setAppDirectLaunch'
        QtMocHelpers::MethodData<void(int, bool)>(25, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 18 }, { QMetaType::Bool, 26 },
        }}),
    };
