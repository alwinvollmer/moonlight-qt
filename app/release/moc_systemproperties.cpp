...
template <> constexpr inline auto SystemProperties::qt_create_metaobjectdata<qt_meta_tag_ZN16SystemPropertiesE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::MethodData<QRect(int)>(4, 2, QMC::AccessPublic, 0x80000000 | 5, {{
            { QMetaType::Int, 6 },
        }}),
        // Method 'getSafeAreaResolution'
        QtMocHelpers::MethodData<QRect(int)>(7, 2, QMC::AccessPublic, 0x80000000 | 5, {{
            { QMetaType::Int, 6 },
        }}),
    ...
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<QString>(18, QMetaType::QString, QMC::DefaultPropertyFlags | QMC::Writable, 0),
        // property 'maximumResolution'
        QtMocHelpers::PropertyData<QSize>(19, 0x80000000 | 20, QMC::DefaultPropertyFlags | QMC::EnumOrFlag | QMC::Constant),
